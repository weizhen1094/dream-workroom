...
/**
  * Helper functions to load powerplant model
  */
#include <fstream> // TODO: pls refactor..
static std::vector<std::string> GetPowerPlantPath(std::string _txtFile)
{
    std::vector<std::string> ret;
    std::ifstream ifs;
    ifs.open(_txtFile, std::fstream::in);
    std::string line;
