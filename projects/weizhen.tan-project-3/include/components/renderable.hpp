...
for generating core primitive geometries.
...
public:
     ...
     */
    Renderable(std::string _meshType = "AABB") : m_MeshType(_meshType) { };
    ~Renderable() { };
...
GeneratePlaneGeometry(vec4 _clr)
{
   ...
   {{-0.5f, 0.0f, -0.5f},  {0.0f, 1.0f, 0.0f}, _clr, {0.0f, 0.0f}},
   {{ 0.5f, 0.0f, -0.5f},  {0.0f, 1.0f, 0.0f}, _clr, {1.0f, 0.0f}},
   {{ 0.5f, 0.0f, 0.5f},   {0.0f, 1.0f, 0.0f}, _clr, {1.0f, 1.0f}},
   {{-0.5f, 0.0f, 0.5f},   {0.0f, 1.0f, 0.0f}, _clr, {0.0f, 1.0f}}
    };
...
{
    std::vector<Vertex> vtx = { {vec3(0),  vec3(0), _clr, vec2(0)}, {vec3(1),  vec3(0), _clr, vec2(0)} };
