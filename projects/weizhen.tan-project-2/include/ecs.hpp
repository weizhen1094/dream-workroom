...
/**
 * @class ECS
 * @brief This class is responsible for storing the entt registry and currently
 * selected entity, creation and cleanup of entities.
 */
...
public:
    ...
    bool IsEntityValid(entt::entity);
    void DestroyEntity(entt::entity);

    /*
     * Helper functions to create entities with components
     */
