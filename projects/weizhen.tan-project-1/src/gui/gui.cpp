...
bool GUI::InitGUI(Window* _pWin)
{
    ...
    CreateSpherevsSphereScene();
    // create child windows
    CreateSceneHierarchyGUI();
    CreateInspectorGUI();
    //CreateBVHGUI();
    CreateTxtFileGUI("../projects/weizhen.tan-project-1/README.txt");
    //CreateTxtFileGUI("../projects/weizhen.tan-project-2/README.txt");
    CreateMainViewportGUI();
    CreateSubViewportGUI();
    //CreateTxtFileGUI("../projects/project-1/README.txt");
...
{
    vec3 camPos = vec3(0.f, 1.f, 7);
  //  vec3 camRot = vec3(-30.f, 0.f, 0.0f);
    float near{ 0.3f }; float far{ 45 };
    m_GUIWindows.push_back(std::make_unique<ViewportGUI>(camPos, /*camRot*/vec3(0), near, far, "Main Viewport",
